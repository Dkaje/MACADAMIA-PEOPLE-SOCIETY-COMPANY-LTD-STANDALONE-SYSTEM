...
Public Sub PopulateListView()
    ...
    Private Sub BSearch_Click(sender As Object, e As EventArgs) Handles BSearch.Click
        ...
        With OleDa
            ...
            .SelectCommand.CommandText = "SELECT * FROM [Customers] WHERE  [First_name] Like '%%" & TxtSearch.Text & "%%' or [Last_name] Like '%%" & TxtSearch.Text & "%%'" & _
            "Or [Email] Like '%%" & TxtSearch.Text & "%%' or [Phone_no] Like '%%" & TxtSearch.Text & "%%' ORDER By [Customer_ID] ASC"
