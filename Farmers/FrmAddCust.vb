        ...
        Try
            ...
            Else
                ...
                With OleDa
                    ...
                    .InsertCommand.CommandText = "INSERT INTO [Customers] ( [First_name] , [Last_name], [Email] , [Phone_no],[ID_number], [Date_added])" & _
                ...
                If MsgBox("Make sales ?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "MAKE SALES...") = MsgBoxResult.Yes Then
