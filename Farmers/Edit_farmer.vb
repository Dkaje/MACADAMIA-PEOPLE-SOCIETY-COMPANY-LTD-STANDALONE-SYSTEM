...
Public Class Edit_farmer
    ...
    Private Sub FillTextbox()
        ...
        With OleDa
            ...
            .SelectCommand.CommandText = "SELECT * FROM [farmers] WHERE ([Farmer_ID] =[@farmerID])"
        ...
        With oledr
            ...
            Else
                .Read()
                Me.LableFarmerID.Text = IIf(.IsDBNull(0), "", .Item("Farmer_ID").ToString())
    ...
    Private Sub Edit_farmer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call FillTextbox()
    End Sub
            ...
            Try
                ...
                Else
                    ...
                    With OleDa
                        ...
                        .UpdateCommand.CommandText = "UPDATE [Farmers] SET [First_name] = @FirstName, [Last_name] = @LastName,[Email] = @Address ," & _
                        "[Phone_no] = @Phone_no,[ID_number]=@IDNo WHERE (Farmer_ID = ?)"
                        ...
                        .UpdateCommand.Parameters.Add(New System.Data.OleDb.OleDbParameter("FarmID", OleDb.OleDbType.VarWChar, 50, _
                                                                                             System.Data.ParameterDirection.Input, False, CType(0, Byte), CType(0, Byte), "FarmID", DataRowVersion.Original, Nothing)).Value = Farmers.LvRecord.SelectedItems(0).Text
