Public Class Sales
    ...
    Private Sub BSearch_Click(sender As Object, e As EventArgs) Handles BSearch.Click
        ...
        With OleDa
            ...
            .SelectCommand.CommandText = "SELECT s.Sales_ID,c.first_name,c.last_name,p.product_name,s.quantity,s.Total FROM (customers AS c INNER JOIN sales AS s ON c.customer_ID=s.customer_ID) INNER JOIN Products AS p ON s.Product_ID=p.StocK_ID WHERE  [First_name] Like '%%" & TxtSearch.Text & "%%' or [Last_name] Like '%%" & TxtSearch.Text & "%%'" & _
            "Or [product_name] Like '%%" & TxtSearch.Text & "%%' or [total] Like '%%" & TxtSearch.Text & "%%' ORDER By [sales_ID] ASC"
