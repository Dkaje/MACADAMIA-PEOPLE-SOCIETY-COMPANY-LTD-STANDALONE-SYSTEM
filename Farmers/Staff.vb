Imports Farmers.ModuleLoadRefreshSearch

Public Class Staff

    'Public MyState As ModuleLoadRefreshSearch.Loading_Refreshing_Searching

    Private Sub FrmMain_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

        Try
            Dim ApplyChanges As System.Configuration.SettingsProperty
            ApplyChanges = New System.Configuration.SettingsProperty(FrmSettings.ChkRefresh.Checked)
            ApplyChanges = New System.Configuration.SettingsProperty(FrmSettings.ChkSearch.Checked)
    ...
    Private Sub BSearch_Click(sender As Object, e As EventArgs) Handles BSearch.Click
        ...
        With OleDa
            ...
            .SelectCommand.CommandText = "SELECT * FROM [Staff] WHERE  [First_name] Like '%%" & TxtSearch.Text & "%%' or [Last_name] Like '%%" & TxtSearch.Text & "%%'" & _
            "Or [Email] Like '%%" & TxtSearch.Text & "%%' or [Phone_no] Like '%%" & TxtSearch.Text & "%%' ORDER By [Staff_ID] ASC"
